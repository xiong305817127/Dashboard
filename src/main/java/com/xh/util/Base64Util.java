...
public class Base64Util {
    ...
    public static UserDto decodeUser(String cookieData){
    	...
    	String userStr = decode(cookieData);
    	JSONObject userJson = JSONObject.fromObject(userStr);
    	long deadline = userJson.optLong("deadline",0L);
    ...
    public static String encodeUser(UserDto user){
    	...
    	userJson.put("deadline",  new Date().getTime()+Utils.SSO_TIMEOUT);
    	String userStr = userJson.toString();
    	return encode(userStr);
    }
