...
public class ClassUtil {
    ...
    private static String toFriendlyClassName(String javaClassName, boolean processInnerClass, String defaultIfInvalid) {
        String name = StringUtils.trimWhitespace(javaClassName);
    ...
    private static final Map<String, PrimitiveInfo<?>> PRIMITIVES = Maps.newHashMap();
    ...
    private final static Map<Class<?>, Set<Class<?>>> assignmentTable = Maps.newHashMap();
    ...
    private static Set<Class<?>> assignableSet(Class<?>... types) {
        Set<Class<?>> assignableSet = Sets.newHashSet();
    ...
    public static String locateClass(String className, ClassLoader loader) {
        className = StringUtils.trimWhitespace(className);
